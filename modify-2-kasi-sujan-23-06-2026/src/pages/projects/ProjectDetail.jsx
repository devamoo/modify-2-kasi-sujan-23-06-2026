...
import DailyPhotoUpdate from "./DailyPhotoUpdate";
...
const PROJECT_TABS = [
  ...
  { key: "workflow", label: "Daily Workflow", icon: FiClock },
  { key: "photos", label: "Photo Updates", icon: FiCamera },
  { key: "weekly", label: "Weekly Report", icon: FiFileText },
  { key: "monthly", label: "Monthly Report", icon: FiBarChart2 },
  { key: "calculator", label: "Schedule Calculator", icon: FiCalendar },
];
  ...
  return (
    <div className="bg-overallbg p-6 font-sans h-full flex flex-col overflow-y-auto lg:overflow-hidden scroll-hidden-bar">
      ...
      <div className="shrink-0 mb-4">
        <div className="flex items-center gap-1 bg-white rounded-2xl p-1.5 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] overflow-x-auto scroll-hidden-bar">
      ...
      {activeProjectTab !== "overview" ? (
        <div className="flex-1 overflow-y-auto scroll-hidden-bar min-h-0">
          {activeProjectTab === "workflow" && <DailyWorkflow lead={lead} />}
          {activeProjectTab === "photos" && <DailyPhotoUpdate lead={lead} />}
          {activeProjectTab === "weekly" && <WeeklyReport lead={lead} />}
          {activeProjectTab === "monthly" && <MonthlyReport lead={lead} />}
          {activeProjectTab === "calculator" && <ScheduleCalculator lead={lead} />}
        </div>
      ) : (
